      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 24 }}>
          <div style={{
            ...
            color: 'var(--jv-brown-700)', flexShrink: 0,
          }}>
            {initials}
          </div>
          <div>
            ...
            <p style={{ margin: 0, fontSize: 13, color: 'var(--jv-ink-muted)' }}>
              {user?.email}
            </p>
            {profile?.role === 'admin' && (
              <span className="badge badge-brown" style={{ marginTop: 6, display: 'inline-block' }}>
                Administrador
              </span>
            )}
          </div>
        ...
        <div className="input-group">
          ...
          {saveMsg && (
            <span style={{
              fontSize: 13,
              color: saveMsg.startsWith('Error') ? 'var(--jv-error)' : 'var(--jv-success)',
            }}>
              {saveMsg}
            </span>
          )}
        ...
        <div className="input-group" style={{ marginTop: 16 }}>
          ...
          <input
            ...
            value={user?.email}
            disabled
            style={{ background: 'var(--jv-brown-50)', cursor: 'not-allowed', color: 'var(--jv-ink-muted)' }}
          />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {pwMsg && (
            <p style={{
              ...
              color: pwMsg.startsWith('Error') ? 'var(--jv-error)' : 'var(--jv-success)',
            }}>
              {pwMsg}
            </p>
          )}
